<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="Cusstomerid" v-model="item.cusstomerid" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Foodid" v-model="item.foodid" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Optionaddress" v-model="item.optionaddress" :editMode="editMode" @change="change" />
            </div>
            <div>
